...
import depedencias.TabelaExtrato;
 ...
 * @author krist
 */
public class ExtratoRMI extends javax.swing.JFrame {
    TableModel tabela;
    TabelaExtrato tabelaEx;
    Registry miRegistry;
    InterfaceABC stub;
    List<Extrato> extratos;
    /**
     * Creates new form ExtratoRMI
     */
    public ExtratoRMI() {
        ...
        try {
                ...
                tabelaEx = new TabelaExtrato(stub.extrato());
                tabela = tabelaEx;
    ...
    private void initComponents() {
        ...
        tabelaExtrato.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExtratoRMI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExtratoRMI().setVisible(true);
            }
        });
    }
